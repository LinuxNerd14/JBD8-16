# Parameters
input_file = "debugger.bin"  # Replace with your binary file
output_file = "debuggerButItDoesntSuck.bin"  # Output file name
...
padding_needed = desired_size - len((b"\xea" * 16770)+original_data)
if padding_needed < 0:
    raise ValueError("File size exceeds the target size of 65535 bytes!")

with open(output_file, "wb") as outfile:
    outfile.write(b"\xea" * 16770)
    outfile.write(original_data)
    outfile.write(b"\xea" * padding_needed)
